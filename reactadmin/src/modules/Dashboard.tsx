...
const Dashboard = () => {
    ...
    const { data, isLoading, isError, refetch } = useQuery([queryKey.doctors], () => statistic())
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5 m-[10px]">
                ...
                <CardDataStats
                    title="Tổng bác sĩ"
                    total={`${data?.statistic.totalDoctor} bác sĩ`}
                ...
                <CardDataStats
                    ...
                    total={`${data?.statistic.totalPatient} bệnh nhân`}
                    classColorName="teal-500"
                >
                    <FaUserInjured className="text-[20px] text-teal-600" />
                </CardDataStats>
                <CardDataStats
                    title="Đơn tháng này" total={`${data?.statistic.totalBookingCurrentMonth} lịch khám`}
                    rate={`${data?.statistic.growBooking}%`}
                    levelUp
                ...
                <CardDataStats
                    ...
                    total={`${addCommas(data?.statistic.revenueAll)} đồng`}

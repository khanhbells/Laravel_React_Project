//pagination
import { pagination, destroy } from "@/service/SpecialtyCatalogueService"
            ...
            <div className="container">
                <Card className="rounded-[5px] mt-[15px] ">
                    <CardHeader className="border-b border-solid border-[#f3f3f3] p-[20px]">
                        <CardTitle className="uppercase">Quản lý danh sách nhóm dịch vụ khám</CardTitle>
                        <CardDescription className="text-xs text-[#f00000]">Hiển thị danh sách nhóm dịch vụ khám, sử dụng các chức năng bên dưới để lọc theo mong muốn</CardDescription>
                    </CardHeader>
                    <CardContent className="p-[15px]">
                        <Filter
                            ...
                            // openSheet={openSheet}
                            items={filterItems}
                            buttonText="Thêm mới nhóm dịch vụ khám"
                            to="/specialty/catalogue/create"
                        />
                        <CustomTable
                            isLoading={isLoading}
                            data={data}
...
export default SpecialtyCatalogue